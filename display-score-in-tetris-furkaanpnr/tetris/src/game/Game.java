...
public class Game {
	...
	private boolean isPieceStored = false;
	...
	public boolean getIsPieceStored(){
		return isPieceStored;
	}

	public void setIsPieceStored(boolean isPieceStored){
		this.isPieceStored = isPieceStored;
	}
	...
	private void render() {
		...
		this.graphics.drawString("Score: " + getScore(), 320,200);
		if(getIsPieceStored()){
